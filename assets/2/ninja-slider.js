...
function NinjaSlider(a) { "use strict";
  ...
  var qb = function() {
      if (O) {
        if (navigator.pointerEnabled) { F = "pointerdown";
          B = "pointermove";
          C = "pointerup" } else if (navigator.msPointerEnabled) { F = "MSPointerDown";
          B = "MSPointerMove";
          C = "MSPointerUp" } else { F = "touchstart";
          B = "touchmove";
          C = "touchend" }
        hb = { handleEvent: function(a) {
            switch (a.type) {
              ...
              case C:
                this.c(a) }
            db(a) }, a: function(a) { b[c][e].left = "0px";
            ...
            if (!y) { cb(a);
              S();
              b[c][e].left = u.x + "px" } }, c: function() {
            var g = +new Date - J.t,
              d = g < 250 && Math.abs(u.x) > 20 || Math.abs(u.x) > b[c].offsetWidth / 2;
            y === null && a.l && !b[c].player && j(c + 1, 1);
            if (y === false)
              if (d) { j(c + (u.x > 0 ? -1 : 1), 1);
                var h = b[c];
                o(function() { h[e].left = "0px" }, 1500) } else { b[c][e].left = "0px";
                j(c, 0) }
  ...
  var Hb = function(a) {
    ...
    A = function(c, f) {
      if (c[i]) {
        for (var e = "", b = c[i].split(" "), a = 0, g = b[d]; a < g; a++)
          if (b[a] !== f) e += b[a] + " ";
        c[i] = e.trim() } },
    tb = function(a) { a[i] = a[i].replace(/\s?sl-\w+/g, "") },
    m = function(a) { a = "#" + n + a.replace("__", g.p);
      g.a.insertRule(a, 0) },
    Db = function(a) {
      ...
      try { typeof atob == "function" && (function(a, c) {
          ...
          typeof this[b] === "function" && this[b](c, lb, mb) })(b, a) } catch (c) {} },
    q = function(a, c, f, e, b) {
      var d = "@" + g.p + "keyframes " + a + " {from{" + c + ";} to{" + f + ";}}";
      g.a.insertRule(d, 0);
      m(" " + e + "{__animation:" + a + " " + b + ";}") },
    sb = function() { q("zoom-in", "transform:scale(1)", "transform:scale(" + a.scale + ")", "li.ns-show .ns-img", a.e + h + "ms 1 alternate none");
      L();
    ...
    rb = function() {
      ...
      L();
      m(" ul li .ns-img {background-size:cover;}") },
    L = function() { m(" li {__transition:opacity " + h + "ms;}") },
    pb = function() {
    ...
    T = function() { m(".fullscreen{z-index:2147483640;top:0;left:0;bottom:0;right:0;width:100%;position:fixed;text-align:center;overflow-y:auto;}");
      ...
      g.a.insertRule(a, 0) },
    xb = function() { q("mcSpinner", "transform:rotate(0deg)", "transform:rotate(360deg)", "li.loading::after", ".6s linear infinite");
    ...
    V = function(b) {
      if (b.rT) { f[e][H] = b.rT;
        if (a.g != "auto") b.rT = 0 } },
    bb = function(d, c, b) {
      if (a.g == "auto" || f[e][H] == "50.1234%") { b.rT = c / d * 100 + "%";
        f[e][H] == "50.1234%" && V(b) } },
    Ab = function(b, l) {
      if (b.lL === undefined) {
        var m = screen.width,
            ...
            for (var c = 1; c < g[d]; c++) { h = g[c].getAttribute("data-screen");
              if (h) { h = h.split("-");
                if (h[d] == 2) {
                  ...
                  if (m >= h[0] && m <= h[1]) { a = g[c];
                    break } } } }
            for (var c = 0; c < g[d]; c++)
              if (g[c] !== a) g[c][e].display = "none" }
          if (a) { b.lL = 1;
            if (a.tagName == "A") { i = a.getAttribute("href");
              z(a, "click", cb) } else if (a.tagName == "IMG") i = a.getAttribute("src");
            else {
              var j = a[e].backgroundImage;
              if (j && j.indexOf("url(") != -1) { j = j.substring(4, j[d] - 1).replace(/[\'\"]/g, "");
                i = j } }
            ...
            if (Fb(f)) { A(b, "loading");
              ...
              f = null } else { f.is1 = l === 1;
              f.mA = a;
              f.mL = b;
              s(b, "loading") } } } else b.lL = 0 }
      b.lL === 0 && l === 1 && N() },
    X = function(a) {
    ...
    N = function() { o(function() { j(c, 9) }, 500);
      z(window, "resize", yb);
      z(k, "visibilitychange", Ib) },
    Y = function(a) {
      if (l && l.playAutoVideo) l.playAutoVideo(a);
      else typeof nsVideoPlugin == "function" && o(function() { Y(a) }, 300) },
    yb = function() { typeof nsVideoPlugin == "function" && l.setIframeSize() },
    vb = function() {
    ...
    j = function(c, e) {
      ...
      eb(c, e) },
    I = function() { w = !w;
      ib[i] = w ? "paused" : "";!w && j(c + 1, 0);
      return w },
    Ib = function() {
      if (a.d)
        if (w) {
          if (l.iframe && l.iframe[p][e].zIndex == "1964") { w = false;
            return }
          o(I, 2200) } else I() },
    S = function() { clearInterval(K);
      K = null };
  ...
  var fb = function(l) {
      ...
      wb();
      Db(a.a);
      if (a.o && a.d) { f.onmouseover = function() { clearTimeout(Q);
          S() };
        f.onmouseout = function() {
          if (d.iframe && d.iframe[p][e].zIndex == "1964") return;
          Q = o(function() { j(c + 1, 1) }, 2e3) } }
      ...
      if (g.a) {
        ...
        if (g.a.insertRule && !q) {
          ...
          g.a.addRule("#" + n + " li[class*='ns-show']", "visibility:visible;", 0) } else { T();
          m(" li[class*='sl-s'] {opacity:1;}") } }(a.c == "zoom" || a.c == "kb") && b[0].nI && U(b[0].nI, 0, b[0].dL);
      if (a.c != "zoom") s(b[0], "ns-show");
      else { b[0][e].opacity = 1;
        s(b[0], "dm-");
        var i = function() {
          if (c === 0) o(i, a.e + h * 2);
          else { b[0][e].opacity = "";
    ...
    wb = function() { a.c = a.transitionType;
      a.a = a.license;
      a.d = a.autoAdvance;
      a.e = a.delay;
      a.g = a.aspectRatio;
    ...
    U = function(b) {
      ...
      if (a.c == "kb") { b[e].WebkitAnimationDirection = b[e].animationDirection = j;
    ...
    ob = function(a) {
      if (R) { 
        ...
        if (v[d]) {
          ...
          while (b--) v[b][i] = "";
          v[a][i] = "active" } } },
    eb = function(d, j) { d = gb(d);
      if (!j && (w || d == c)) return;
      clearTimeout(K);
      b[d][e].left = "0px";
      for (var i = 0, q = r; i < q; i++) { b[i][e].zIndex = i === d ? 1 : i === c ? 0 : -1;
        if (i != d)
          if (i == c && (a.c == "zoom" || a.c == "kb")) {
            var n = i;
            o(function() { A(b[n], "ns-show") }, h) } else A(b[i], "ns-show");
          (a.c == "slide" || a.m) && tb(b[i]) }
      if (j != 9)
        if (a.c == "slide" || a.m && j) {!j && s(b[d], "ns-show");
          var l = d > c || !d && c == r - 1;
          if (!c && d != 1 && d == r - 1) l = 0;
          var k = a.c == "slide" && f[p][p].offsetWidth == f[p].offsetWidth ? "2" : "";
          if (l) { s(b[c], "sl-cl" + k);
            s(b[d], "sl-sl" + k) } else { s(b[c], "sl-cr" + k);
            s(b[d], "sl-sr" + k) }
          var n = c } else { s(b[d], "ns-show");
      ...
      b[d].player && Y(b[d]);
      if (a.d) K = o(function() { eb(d + 1, 0) }, b[d].dL) };
  fb.prototype = { b: function() {
      var g = f.children,
        e;
      r = g[d];
      for (var c = 0, h = g[d]; c < h; c++) { b[c] = g[c];
        b[c].ix = c;
        e = b[c].getAttribute("data-delay");
        b[c].dL = e ? parseInt(e) : a.e } }, c: function() { Bb(f);
      this.b();
      var e = 0;
      if (a.j) {
      ...
      if (a.g.indexOf(":") != -1) {
        var b = a.g.split(":"),
          c = b[1] / b[0];
        f[e][H] = c * 100 + "%" } else f[e][H] = "50.1234%";
      f[e].height = "0" }, e: function(b, d) {
      var c = n + b,
        a = k.getElementById(c);
      if (!a) { a = k.createElement("div");
        a.id = c;
        a = f[p].appendChild(a) }
      if (b != "-pager") { a.onclick = d;
        O && a[t]("touchstart", function(a) { a.preventDefault();
          a.target.click();
          db(a) }, false) }
      return a }, addNavs: function() {
      if (r > 1) {
        ...
        for (var a = 0; a < v[d]; a++) {
          ...
          v[a].onclick = function() {
            ...
            a != c && j(a, 1) } }
        jb = this.e("-prev", function() { j(c - 1, 1) });
        R = this.e("-next", function() { j(c + 1, 1) });
      ...
      if (m)
        for (var a = 0; a < m; a++)
          if (D(h[a], "fs-icon")) {
            var g = h[a];
            break }
      if (g) { z(g, "click", function() {
          var f = G(n),
            c = D(f, "fullscreen");
          if (c) { A(f, "fullscreen");
            k.documentElement[e].overflow = "auto" } else { s(f, "fullscreen");
            k.documentElement[e].overflow = "hidden" }
          typeof fsIconClick == "function" && fsIconClick(c);
          for (var a, g = 0; g < b[d]; g++) { a = b[g];
            if (a.nIs)
              if (a.nI.tagName == "IMG") a.nI.src = a.nIs[c ? 1 : 0];
              else a.nI[e].backgroundImage = "url('" + a.nIs[c ? 1 : 0] + "')" } });
        z(k, "keydown", function(a) { a.keyCode == 27 && D(G(n), "fullscreen") && g.click() }) } }, sliderId: n, stop: S, getLis: function() {
      return b }, getIndex: function() {
      return c }, next: function() { a.d && j(c + 1, 1) } };
  var M = function() {
      var a = G(n);
      if (a) {
  ...
  return { displaySlide: function(a) {
      if (b[d]) {
        ...
        j(c, 0) } }, next: function() { j(c + 1, 1) }, prev: function() { j(c - 1, 1) }, toggle: I, getPos: function() {
      return c }, getSlides: function() {
      return b }, playVideo: function(a) {
      if (typeof a == "number") a = b[a];
      if (a.player) { j(a.ix, 0);
        l.playVideo(a.player) } }, init: function(a) {!l && M();
